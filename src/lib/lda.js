// Ported from: https://github.com/primaryobjects/lda to ReactJS compatible

import { stem } from './stemmer/en.js';
import { STOPWORDS } from '../utils/constants.js'
...
export const LDA = (sentences, numberOfTopics, numberOfTermsPerTopic, languages, alphaValue, betaValue, randomSeed) => {
